...
proc create_hier_cell_Clocks_and_Resets { parentCell nameHier } {
  ...
  create_bd_pin -dir O clk_50MHZ
  create_bd_pin -dir O clk_5MHZ
  ...
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins clk_100MHZ] [get_bd_pins clk_wiz_0/clk_out3]
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins clk_50MHZ] [get_bd_pins clk_wiz_0/clk_out4]
  connect_bd_net -net clk_wiz_0_clk_out5 [get_bd_pins clk_5MHZ] [get_bd_pins clk_wiz_0/clk_out5]
...
proc create_root_design { parentCell } {
  ...
  set GPIO_CAM [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 GPIO_CAM ]
  ...
  # Create ports
  set BEEP [ create_bd_port -dir O BEEP ]
  set BT_TXD [ create_bd_port -dir O BT_TXD ]
  set CLK_0832 [ create_bd_port -dir O CLK_0832 ]
  set CS_0832 [ create_bd_port -dir O CS_0832 ]
  set D0832 [ create_bd_port -dir I D0832 ]
  set DHT_Data [ create_bd_port -dir IO DHT_Data ]
  set DI_0832 [ create_bd_port -dir O DI_0832 ]
  set HMI_RXD [ create_bd_port -dir I HMI_RXD ]
  set HMI_TXD [ create_bd_port -dir O HMI_TXD ]
  set IO_PRINTER [ create_bd_port -dir O -from 7 -to 0 IO_PRINTER ]
  set LED [ create_bd_port -dir O LED ]
  set MPU_RXD [ create_bd_port -dir I MPU_RXD ]
  ...
  # Create instance: Exin_ADC0832_0, and set properties
  set Exin_ADC0832_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Exin_ADC0832:1.0 Exin_ADC0832_0 ]

  # Create instance: Exin_HMITX_0, and set properties
  set Exin_HMITX_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Exin_HMITX:1.0 Exin_HMITX_0 ]

  # Create instance: Exin_HeartFre2_0, and set properties
  set Exin_HeartFre2_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Exin_HeartFre2:1.0 Exin_HeartFre2_0 ]

  # Create instance: Exin_IO_printer_0, and set properties
  set Exin_IO_printer_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Exin_IO_printer:1.0 Exin_IO_printer_0 ]
  set_property -dict [ list \
   CONFIG.n {500000} \
 ] $Exin_IO_printer_0

  # Create instance: Exin_MAXMIN2_0, and set properties
  set Exin_MAXMIN2_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Exin_MAXMIN2:1.0 Exin_MAXMIN2_0 ]

  # Create instance: Exin_MPU6050_GYXX_0, and set properties
  set Exin_MPU6050_GYXX_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Exin_MPU6050_GYXX:1.0 Exin_MPU6050_GYXX_0 ]

  # Create instance: Exin_StepCounter_deb_0, and set properties
  set Exin_StepCounter_deb_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Exin_StepCounter_debug:1.0 Exin_StepCounter_deb_0 ]

  # Create instance: Exin_Timer_0, and set properties
  set Exin_Timer_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Exin_Timer:1.0 Exin_Timer_0 ]

  # Create instance: Exin_beep_0, and set properties
  set Exin_beep_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Exin_beep:1.0 Exin_beep_0 ]

  # Create instance: Exin_clk_wizard_0, and set properties
  set Exin_clk_wizard_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Exin_clk_wizard:1.0 Exin_clk_wizard_0 ]
  set_property -dict [ list \
   CONFIG.n {4} \
 ] $Exin_clk_wizard_0

  # Create instance: Exin_clk_wizard_1, and set properties
  set Exin_clk_wizard_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:Exin_clk_wizard:1.0 Exin_clk_wizard_1 ]
  set_property -dict [ list \
   CONFIG.n {50} \
 ] $Exin_clk_wizard_1

  # Create instance: Exin_dht11_0, and set properties
  set Exin_dht11_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Exin_dht11:1.0 Exin_dht11_0 ]
  ...
  # Create instance: breath_led_0, and set properties
  set breath_led_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:breath_led:1.0 breath_led_0 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports GPIO_CAM] [get_bd_intf_pins axi_gpio_2/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins Exin_ADC0832_0/S0_AXI] [get_bd_intf_pins axi_interconnect_0/M06_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins Exin_HeartFre2_0/S0_AXI] [get_bd_intf_pins axi_interconnect_0/M07_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins Exin_MAXMIN2_0/S0_AXI] [get_bd_intf_pins axi_interconnect_0/M08_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M09_AXI [get_bd_intf_pins Exin_dht11_0/S0_AXI] [get_bd_intf_pins axi_interconnect_0/M09_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M10_AXI [get_bd_intf_pins Exin_MPU6050_GYXX_0/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M10_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M11_AXI [get_bd_intf_pins Exin_StepCounter_deb_0/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M11_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M12_AXI [get_bd_intf_pins axi_interconnect_0/M12_AXI] [get_bd_intf_pins breath_led_0/S0_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M13_AXI [get_bd_intf_pins Exin_Timer_0/S0_AXI] [get_bd_intf_pins axi_interconnect_0/M13_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M14_AXI [get_bd_intf_pins Exin_beep_0/S0_AXI] [get_bd_intf_pins axi_interconnect_0/M14_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M15_AXI [get_bd_intf_pins axi_interconnect_0/M15_AXI] [get_bd_intf_pins axi_uartlite_1/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M16_AXI [get_bd_intf_pins Exin_IO_printer_0/S0_AXI] [get_bd_intf_pins axi_interconnect_0/M16_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M17_AXI [get_bd_intf_pins axi_gpio_2/S_AXI] [get_bd_intf_pins axi_interconnect_0/M17_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M18_AXI [get_bd_intf_pins Exin_HMITX_0/S0_AXI] [get_bd_intf_pins axi_interconnect_0/M18_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M19_AXI [get_bd_intf_pins Exin_noliner2_0/S0_AXI] [get_bd_intf_pins axi_interconnect_0/M19_AXI]
  connect_bd_intf_net -intf_net axi_quad_spi_0_SPI_0 [get_bd_intf_ports qspi_flash] [get_bd_intf_pins axi_quad_spi_0/SPI_0]

  # Create port connections
  connect_bd_net -net Clocks_and_Resets_clk_100MHZ [get_bd_pins Clocks_and_Resets/clk_100MHZ] [get_bd_pins Exin_Timer_0/clk]
  connect_bd_net -net Clocks_and_Resets_clk_50MHZ [get_bd_pins Clocks_and_Resets/clk_50MHZ] [get_bd_pins Exin_HMITX_0/clk] [get_bd_pins Exin_MPU6050_GYXX_0/clk] [get_bd_pins Exin_StepCounter_deb_0/clk] [get_bd_pins Exin_beep_0/clk] [get_bd_pins Exin_clk_wizard_1/clk] [get_bd_pins Exin_noliner2_0/clk]
  connect_bd_net -net Clocks_and_Resets_clk_5MHZ [get_bd_pins Clocks_and_Resets/clk_5MHZ] [get_bd_pins Exin_IO_printer_0/clk] [get_bd_pins Exin_clk_wizard_0/clk]
  connect_bd_net -net Clocks_and_Resets_dbgresetn [get_bd_pins Clocks_and_Resets/dbgresetn] [get_bd_pins Cortex_M3_0/DBGRESETn]
  connect_bd_net -net Clocks_and_Resets_peripheral_aresetn1 [get_bd_pins Clocks_and_Resets/peripheral_aresetn1] [get_bd_pins Exin_ADC0832_0/s0_axi_aresetn] [get_bd_pins Exin_HMITX_0/s0_axi_aresetn] [get_bd_pins Exin_HeartFre2_0/s0_axi_aresetn] [get_bd_pins Exin_IO_printer_0/s0_axi_aresetn] [get_bd_pins Exin_MAXMIN2_0/s0_axi_aresetn] [get_bd_pins Exin_MPU6050_GYXX_0/s00_axi_aresetn] [get_bd_pins Exin_StepCounter_deb_0/s00_axi_aresetn] [get_bd_pins Exin_Timer_0/s0_axi_aresetn] [get_bd_pins Exin_beep_0/s0_axi_aresetn] [get_bd_pins Exin_dht11_0/s0_axi_aresetn] [get_bd_pins Exin_noliner2_0/s0_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/M07_ARESETN] [get_bd_pins axi_interconnect_0/M08_ARESETN] [get_bd_pins axi_interconnect_0/M09_ARESETN] [get_bd_pins axi_interconnect_0/M10_ARESETN] [get_bd_pins axi_interconnect_0/M11_ARESETN] [get_bd_pins axi_interconnect_0/M12_ARESETN] [get_bd_pins axi_interconnect_0/M13_ARESETN] [get_bd_pins axi_interconnect_0/M14_ARESETN] [get_bd_pins axi_interconnect_0/M15_ARESETN] [get_bd_pins axi_interconnect_0/M16_ARESETN] [get_bd_pins axi_interconnect_0/M17_ARESETN] [get_bd_pins axi_interconnect_0/M18_ARESETN] [get_bd_pins axi_interconnect_0/M19_ARESETN] [get_bd_pins axi_uartlite_1/s_axi_aresetn] [get_bd_pins breath_led_0/s0_axi_aresetn]
  ...
  connect_bd_net -net D0832_1 [get_bd_ports D0832] [get_bd_pins Exin_ADC0832_0/D0832]
  connect_bd_net -net Exin_ADC0832_0_DI [get_bd_ports DI_0832] [get_bd_pins Exin_ADC0832_0/DI]
  connect_bd_net -net Exin_ADC0832_0_OUT0832 [get_bd_pins Exin_ADC0832_0/OUT0832] [get_bd_pins Exin_HeartFre2_0/data] [get_bd_pins Exin_MAXMIN2_0/data]
  connect_bd_net -net Exin_ADC0832_0_clk_0832 [get_bd_ports CLK_0832] [get_bd_pins Exin_ADC0832_0/clk_0832]
  connect_bd_net -net Exin_ADC0832_0_cs [get_bd_ports CS_0832] [get_bd_pins Exin_ADC0832_0/cs]
  connect_bd_net -net Exin_HMITX_0_dout [get_bd_ports BT_TXD] [get_bd_pins Exin_HMITX_0/dout]
  connect_bd_net -net Exin_IO_printer_0_IO [get_bd_ports IO_PRINTER] [get_bd_pins Exin_IO_printer_0/IO]
  connect_bd_net -net Exin_MAXMIN2_0_Thread0 [get_bd_pins Exin_HeartFre2_0/SCH_thread0] [get_bd_pins Exin_MAXMIN2_0/Thread0]
  connect_bd_net -net Exin_beep_0_beep_IO [get_bd_ports BEEP] [get_bd_pins Exin_beep_0/beep_IO]
  connect_bd_net -net Exin_clk_wizard_0_q [get_bd_pins Exin_ADC0832_0/clk] [get_bd_pins Exin_clk_wizard_0/q]
  connect_bd_net -net Exin_clk_wizard_1_q [get_bd_pins Exin_HeartFre2_0/clk] [get_bd_pins Exin_MAXMIN2_0/clk] [get_bd_pins Exin_clk_wizard_1/q] [get_bd_pins Exin_dht11_0/clk]
  connect_bd_net -net HMI_RXD_1 [get_bd_ports HMI_RXD] [get_bd_pins axi_uartlite_1/rx]
  connect_bd_net -net MPU_RXD_1 [get_bd_ports MPU_RXD] [get_bd_pins Exin_MPU6050_GYXX_0/rxd]
  connect_bd_net -net Net [get_bd_ports DHT_Data] [get_bd_pins Exin_dht11_0/Data]
  ...
  connect_bd_net -net axi_gpio_2_ip2intc_irpt [get_bd_pins axi_gpio_2/ip2intc_irpt] [get_bd_pins xlconcat_0/In10]
  ...
  connect_bd_net -net axi_uartlite_1_tx [get_bd_ports HMI_TXD] [get_bd_pins axi_uartlite_1/tx]
  connect_bd_net -net breath_led_0_led [get_bd_ports LED] [get_bd_pins breath_led_0/led]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins Clocks_and_Resets/clk_cpu] [get_bd_pins Cortex_M3_0/HCLK] [get_bd_pins Exin_ADC0832_0/s0_axi_aclk] [get_bd_pins Exin_HMITX_0/s0_axi_aclk] [get_bd_pins Exin_HeartFre2_0/s0_axi_aclk] [get_bd_pins Exin_IO_printer_0/s0_axi_aclk] [get_bd_pins Exin_MAXMIN2_0/s0_axi_aclk] [get_bd_pins Exin_MPU6050_GYXX_0/s00_axi_aclk] [get_bd_pins Exin_StepCounter_deb_0/s00_axi_aclk] [get_bd_pins Exin_Timer_0/s0_axi_aclk] [get_bd_pins Exin_beep_0/s0_axi_aclk] [get_bd_pins Exin_dht11_0/s0_axi_aclk] [get_bd_pins Exin_noliner2_0/s0_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/M09_ACLK] [get_bd_pins axi_interconnect_0/M10_ACLK] [get_bd_pins axi_interconnect_0/M11_ACLK] [get_bd_pins axi_interconnect_0/M12_ACLK] [get_bd_pins axi_interconnect_0/M13_ACLK] [get_bd_pins axi_interconnect_0/M14_ACLK] [get_bd_pins axi_interconnect_0/M15_ACLK] [get_bd_pins axi_interconnect_0/M16_ACLK] [get_bd_pins axi_interconnect_0/M17_ACLK] [get_bd_pins axi_interconnect_0/M18_ACLK] [get_bd_pins axi_interconnect_0/M19_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axi_uartlite_1/s_axi_aclk] [get_bd_pins breath_led_0/s0_axi_aclk] [get_bd_pins daplink_if_0/s_axi_aclk]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins Exin_clk_wizard_0/rst] [get_bd_pins Exin_clk_wizard_1/rst] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins Exin_beep_0/start] [get_bd_pins xlconstant_2/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs Exin_ADC0832_0/S0_AXI/S0_AXI_reg] SEG_Exin_ADC0832_0_S0_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44AB0000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs Exin_HMITX_0/S0_AXI/S0_AXI_reg] SEG_Exin_HMITX_0_S0_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs Exin_HeartFre2_0/S0_AXI/S0_AXI_reg] SEG_Exin_HeartFre2_0_S0_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A90000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs Exin_IO_printer_0/S0_AXI/S0_AXI_reg] SEG_Exin_IO_printer_0_S0_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs Exin_MAXMIN2_0/S0_AXI/S0_AXI_reg] SEG_Exin_MAXMIN2_0_S0_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A40000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs Exin_MPU6050_GYXX_0/S00_AXI/S00_AXI_reg] SEG_Exin_MPU6050_GYXX_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A50000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs Exin_StepCounter_deb_0/S00_AXI/S00_AXI_reg] SEG_Exin_StepCounter_deb_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A70000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs Exin_Timer_0/S0_AXI/S0_AXI_reg] SEG_Exin_Timer_0_S0_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A80000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs Exin_beep_0/S0_AXI/S0_AXI_reg] SEG_Exin_beep_0_S0_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A30000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs Exin_dht11_0/S0_AXI/S0_AXI_reg] SEG_Exin_dht11_0_S0_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44AA0000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs Exin_noliner2_0/S0_AXI/S0_AXI_reg] SEG_Exin_noliner2_0_S0_AXI_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40040000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] SEG_axi_gpio_2_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40600000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs axi_uartlite_1/S_AXI/Reg] SEG_axi_uartlite_1_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A60000 [get_bd_addr_spaces Cortex_M3_0/CM3_SYS_AXI3] [get_bd_addr_segs breath_led_0/S0_AXI/S0_AXI_reg] SEG_breath_led_0_S0_AXI_reg
