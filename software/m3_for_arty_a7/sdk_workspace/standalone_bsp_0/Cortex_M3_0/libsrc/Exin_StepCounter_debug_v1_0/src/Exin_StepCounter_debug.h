...
extern int PULL_UP;
extern int JMP_UP;
extern unsigned int state;//状态机器
extern unsigned int state1;//状态机器
extern unsigned int move_step;//运动模式第一阶段
extern int move_time0;//运动时间记录当前运动起始时间
extern int move_time1;//运动时间记录当前运动结束时间
extern int step_time;//运动轮次转换时间
extern int step_state;//记录当前运动阶段
extern int step_up;//每次运动量增加/起始运动量
extern int move_sum;//运动总量
